...
namespace StreetFood.Repositories.ProvidersImpl {
  public class StockProductsProvider : IStockProductsProvider {
    ...
    public StockProductBO? GetByIngredientId(int ingredientId) {
      ...
      StockProduct stockProduct = this.stockProductsRepository.GetByIngredientId(ingredientId);
      return new StockProductBO() { 
        Id = stockProduct.Id,
        IngredientId = stockProduct.IngredientId,
        Count = stockProduct.Count,
        LastRevisionDate = stockProduct.LastRevisionDate 
      };
    }
  }
}
